...
effects:
  - kind: text
    ...
    text: +50% Regeneration
examples: []
id: feat.general.schnelle-erholung
legacy:
  notes: []
  paths:
    - feats/feats_overview.md
    - feats/feat_schnelle_erholung.md
level: 1
...
rulesText: "# Schnelle Erholung\r
  ...
  **Quelle:** Welt-Regelwerk (Zeitalter des Goldes)\r
  ...
  > „Die Fähigkeit zur schnellen Erholung ist der Unterschied zwischen Überleben und Tod.\"\r

  \r

  Schnelle Erholung ist eine Fähigkeit, die es Charakteren ermöglicht, sich schneller von Verletzungen und Erschöpfung zu erholen. In der gefährlichen Welt des Zeitalters des Goldes, wo Kämpfe und Verletzungen an der Tagesordnung sind, ist diese Fähigkeit von unschätzbarem Wert.\r
  ...
  Schnelle Erholung erhöht die Regenerationsfähigkeit eines Charakters erheblich, wodurch er sich schneller von Verletzungen erholen kann. Diese Fähigkeit ist besonders nützlich für Kämpfer und alle, die sich regelmäßig in gefährliche Situationen begeben.\r
  ...
  - **Regeneration:** +50% mehr Trefferpunkte bei Ruhe\r
  ...
  - **Normale Regeneration:** 1 TP pro Stunde\r

  - **Mit Schneller Erholung:** 1,5 TP pro Stunde\r

  - **Beispiel:** Ein Charakter der Stufe 5 regeneriert normalerweise 5 TP pro Stunde, mit dieser Fähigkeit 7,5 TP pro Stunde\r
  ...
  - **Schnellere Heilung:** Deutlich reduzierte Erholungszeit\r

  - **Kampfbereitschaft:** Schneller wieder einsatzbereit\r

  - **Ressourcenschonung:** Weniger magische Heilung nötig\r

  - **Überleben:** Bessere Überlebenschancen bei Verletzungen\r
  ...
  - **Spezialisierung:** Fokussiert auf Regeneration statt andere Fähigkeiten\r

  - **Abhängigkeit:** Wirkt nur bei natürlicher Heilung\r
  ...
  - **Zähigkeit:** Kombiniert hohe TP mit schneller Regeneration\r

  - **Mediziner-Beruf:** Verstärkt die Heilungsfähigkeiten\r

  - **Magische Heilung:** Ergänzt magische Heilung optimal\r
  ...
  - **Wächter:** Defensive Kämpfer nutzen die Regeneration optimal\r

  - **Raufbold:** Straßenkämpfer brauchen schnelle Erholung\r

  - **Mediziner:** Heiler können sich selbst besser versorgen\r
  ...
  - **Durchhaltevermögen:** Längere Kämpfe überstehen\r

  - **Risikomanagement:** Gefährliche Manöver wagen\r

  - **Gruppenschutz:** Als \"Tank\" für die Gruppe fungieren\r

  - **Nachkampf:** Schneller wieder einsatzbereit\r

  \r

  ### **Außerhalb des Kampfes**\r

  - **Missionen:** Schneller zwischen gefährlichen Missionen erholen\r

  - **Reisen:** Weniger Zeit für Erholung auf Reisen\r

  - **Training:** Schneller von anstrengendem Training erholen\r

  - **Stress:** Besser mit körperlichem Stress umgehen\r
  ...
  - **Veteran:** Erfahrener Kämpfer mit schneller Erholung\r

  - **Überlebenskünstler:** Jemand, der gelernt hat, sich schnell zu erholen\r

  - **Athlet:** Sportler mit schneller Regeneration\r

  - **Mediziner:** Jemand mit medizinischem Wissen über Heilung\r

  \r

  ### **Geschichtliche Integration**\r

  - **Militär:** Soldaten mit schneller Erholung\r

  - **Konzerne:** Sicherheitskräfte und Bodyguards\r

  - **Untergrund:** Straßenkämpfer und Überlebenskünstler\r

  - **Wissenschaft:** Mediziner und Biologen\r
  ...
  - **Natürliche Heilung:** Verstärkt die natürliche Regeneration\r

  - **Magische Heilung:** Ergänzt magische Heilung optimal\r

  - **Medizinische Behandlung:** Verstärkt medizinische Heilung\r

  - **Ruhe:** Funktioniert nur bei echter Ruhe\r

  \r

  ### **Spezialfälle**\r

  - **Kurze Rast:** Funktioniert bei kurzen Ruhepausen\r

  - **Lange Rast:** Funktioniert bei langen Ruhepausen\r

  - **Schlaf:** Funktioniert auch im Schlaf\r

  - **Bewusstlosigkeit:** Funktioniert auch bei Bewusstlosigkeit\r
  ...
  Schnelle Erholung ist eine der wichtigsten Überlebensfähigkeiten im Zeitalter des Goldes. In einer Welt voller Gefahren, wo Verletzungen und Erschöpfung an der Tagesordnung sind, ist die Fähigkeit, sich schnell zu erholen, oft der Unterschied zwischen Leben und Tod.\r
