...
rulesText: "# **Magie Aufheben**\r
  ...
  **Quelle:** Welt-Regelwerk (Zeitalter des Goldes)\r
  ...
  | Arcane, Divine, Occult, Primal | 3 | 2 Aktionen | 60 Fuß | 1 magischer Effekt | Sofort |\r
  ...
  Du unterbrichst einen aktiven magischen Effekt und beendest ihn vorzeitig.\r

  \r

  **Zauberwurf:** Zauberwurf gegen den ursprünglichen Zauber-SG des Effekts\r

  **Effekt:** Der magische Effekt wird beendet, wenn dein Wurf erfolgreich ist.\r

  **Kritischer Erfolg:** Der Effekt wird beendet und kann für 1 Stunde nicht erneut gewirkt werden.\r
  ...
  - **Rang 4:** Du kannst alle magischen Effekte auf einem Ziel beenden\r

  - **Rang 5:** Du kannst alle magischen Effekte in einem 10-Fuß-Radius beenden\r

  - **Rang 6:** Du kannst alle magischen Effekte in einem 20-Fuß-Radius beenden\r
  ...
  - **Geflecht-Verstärkung:** In Gebieten mit starkem magischen Geflecht erhältst du +2 auf den Zauberwurf.\r

  - **Technologische Interferenz:** Moderne Überwachungssysteme können die Magieunterdrückung stören oder umleiten.\r
  ...
  > „Die Macht, die Magie bricht – ein gefährliches Wissen in den Händen derer, die das Geflecht verstehen.\"\r
