...
choiceIds:
  ...
  - choice.class-feat.agent.1
  - choice.class-feat.agent.2
  - choice.class-feat.agent.4
  - choice.class-feat.agent.6
  - choice.class-feat.agent.8
  - choice.class-feat.agent.10
  - choice.class-feat.agent.12
  - choice.class-feat.agent.14
...
featureIds:
  ...
  - class-feature.agent.vorgehensweise.infiltrator
  - class-feature.agent.vorgehensweise.manipulator
  - class-feature.agent.vorgehensweise.attentater
  - class-feature.agent.vorgehensweise
  - class-feature.agent.schnelle-reaktion
  - class-feature.agent.kalter-verstand
  - class-feature.agent.unauffalligkeit
  - class-feature.agent.katalysator
  - class-feature.agent.phantom
hpPerLevel: 8
id: class.agent
...
status: legacy
summary: Agenten sind die Schatten zwischen den Fronten.
