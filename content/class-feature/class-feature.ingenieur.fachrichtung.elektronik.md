...
examples: []
id: class-feature.ingenieur.fachrichtung.elektronik
legacy:
  notes: []
  paths:
...
prerequisites: []
references: []
rulesText: "Du arbeitest mit Strom, Frequenzen und Schaltkreisen.  \r
...
status: legacy
summary: Du arbeitest mit Strom, Frequenzen und Schaltkreisen.
traits:
  - trait.class-option
