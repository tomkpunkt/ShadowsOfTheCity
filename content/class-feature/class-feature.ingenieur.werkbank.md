...
examples: []
id: class-feature.ingenieur.werkbank
legacy:
  notes: []
  paths:
...
prerequisites: []
references: []
rulesText: "Du besitzt eine persönliche Werkzeugtasche oder mobile Werkbank.  \r
...
status: legacy
summary: Du besitzt eine persönliche Werkzeugtasche oder mobile Werkbank.
traits:
  - trait.legacy
type: class-feature
---
