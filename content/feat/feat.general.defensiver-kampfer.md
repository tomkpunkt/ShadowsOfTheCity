...
effects:
  - classification: partially-structured
    ...
    text: +1 AC Verteidigung
examples: []
id: feat.general.defensiver-kampfer
legacy:
  notes: []
  paths:
    - feats/feats_overview.md
    - feats/feat_defensiver_kaempfer.md
level: 1
name: Defensiver Kämpfer
prerequisites:
  - all:
      - attribute:
          gte: 13
          id: constitution
references: []
rulesText: "# Defensiver Kämpfer\r
  ...
  **Quelle:** Welt-Regelwerk (Zeitalter des Goldes)\r
  ...
  > „Der beste Angriff ist eine gute Verteidigung.\"\r

  \r

  Defensiver Kämpfer ist eine Fähigkeit, die es Charakteren ermöglicht, ihre Verteidigung zu verbessern und sich besser vor Angriffen zu schützen. In der gefährlichen Welt des Zeitalters des Goldes, wo Kämpfe und Angriffe an der Tagesordnung sind, ist diese Fähigkeit von unschätzbarem Wert.\r
  ...
  Defensiver Kämpfer verbessert die Verteidigungsfähigkeit eines Charakters, wodurch er sich besser vor Angriffen schützen kann. Diese Fähigkeit ist besonders nützlich für Wächter, defensive Kämpfer und alle, die sich auf Verteidigung spezialisieren.\r
  ...
  - **Verteidigung:** +1 AC wenn Verteidigung gewählt wird\r

  - **Dauer:** Bis zum nächsten Zug\r
  ...
  - **Verteidigung:** Sich vor Angriffen schützen\r

  - **Schutz:** Verbündete vor Angriffen schützen\r

  - **Taktik:** Defensive Kampftaktiken\r

  - **Überleben:** Länger im Kampf überleben\r
  ...
  - **Schutz:** Bessere Verteidigung gegen Angriffe\r

  - **Überleben:** Länger im Kampf überleben\r

  - **Taktik:** Mehr taktische Optionen im Kampf\r
  ...
  - **Spezialisierung:** Fokussiert auf Verteidigung statt Angriff\r

  - **Abhängigkeit:** Wirkt nur bei Verteidigungsaktion\r
  ...
  - **Zähigkeit:** Kombiniert hohe TP mit guter Verteidigung\r

  - **Schnelle Erholung:** Verstärkt die Regenerationsfähigkeit\r

  - **Athletischer Kampfstil:** Kombiniert Verteidigung mit Offensive\r

  - **Taktiker:** Unterstützt Verbündete durch Verteidigung\r

  \r

  ### **Klassenempfehlungen**\r

  - **Wächter:** Defensive Kämpfer profitieren am meisten\r

  - **Söldner:** Professionelle Kämpfer können sich verteidigen\r

  - **Raufbold:** Straßenkämpfer können sich schützen\r

  - **Agent:** Spione können sich verteidigen\r
  ...
  - **Verteidigung:** Sich vor Überraschungsangriffen schützen\r

  - **Taktik:** Defensive Taktiken in gefährlichen Situationen\r

  - **Überleben:** In gefährlichen Situationen überleben\r
  ...
  - **Wächter:** Professioneller Wächter mit defensiven Fähigkeiten\r

  - **Bodyguard:** Leibwächter mit defensiven Fähigkeiten\r

  - **Soldat:** Soldat mit defensiven Fähigkeiten\r
  ...
  - **Militär:** Soldaten und Wächter\r

  - **Konzerne:** Sicherheitskräfte und Bodyguards\r

  - **Polizei:** Polizisten und Ordnungshüter\r
  ...
  - **Konstitution:** Verstärkt das Konstitutionsattribut\r

  - **Rüstung:** Kombiniert mit Rüstungsschutz\r

  - **Verteidigung:** Verstärkt die Verteidigungsaktion\r

  - **AC:** Erhöht die Rüstungsklasse\r

  \r

  ### **Spezialfälle**\r

  - **Verteidigung:** Funktioniert nur bei Verteidigungsaktion\r

  - **Rüstung:** Kombiniert mit Rüstungsschutz\r

  - **Magie:** Magische Effekte können die Verteidigung beeinträchtigen\r
  ...
  Defensiver Kämpfer ist eine der wichtigsten Fähigkeiten für defensive Kämpfer im Zeitalter des Goldes. In einer Welt voller Gefahren, wo Angriffe und Kämpfe an der Tagesordnung sind, ist die Fähigkeit, sich zu verteidigen, oft der Schlüssel zum Überleben.\r
