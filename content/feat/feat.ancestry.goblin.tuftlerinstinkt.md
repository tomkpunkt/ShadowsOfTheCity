...
examples: []
id: feat.ancestry.goblin.tuftlerinstinkt
legacy:
  notes: []
  paths:
    - races/goblins_zeitalter_des_goldes.md
level: 9
name: Tüftlerinstinkt
prerequisites:
  - ancestry:
      id: ancestry.goblin
references: []
rulesText: Du kannst eine einfache Maschine oder Vorrichtung in der halben üblichen Zeit reparieren oder modifizieren. Wenn du improvisierte Sprengsätze oder Fallen baust, erhalten sie +1 auf Angriffs- oder SG-Würfe.
schemaVersion: 1
