---
choiceIds:
  - choice.soldner.kampfstil
  - choice.class-feat.soldner.1
  - choice.class-feat.soldner.2
  - choice.class-feat.soldner.4
  - choice.class-feat.soldner.6
  - choice.class-feat.soldner.8
  - choice.class-feat.soldner.10
  - choice.class-feat.soldner.12
  - choice.class-feat.soldner.14
...
featureIds:
  ...
  - class-feature.soldner.kampfstil.scharfschutze
  - class-feature.soldner.kampfstil.wachter
  - class-feature.soldner.kampfstil
  - class-feature.soldner.erfahrener-kampfer
  - class-feature.soldner.unnachgiebig
  - class-feature.soldner.kriegsinstinkt
  - class-feature.soldner.veteran-des-goldes
  - class-feature.soldner.legende-des-krieges
hpPerLevel: 10
id: class.soldner
...
rulesText: "# **Söldner**\r
  ...
  **Quelle:** Welt-Regelwerk (Zeitalter des Goldes)\r
  ...
  > „Loyalität ist eine Ware. Ich verkaufe sie an den, der sie sich leisten kann.“\r

  \r

  Söldner sind Männer und Frauen, die gelernt haben, mit Waffen zu leben – und mit ihren Konsequenzen.  \r

  Sie kämpfen für Geld, für Stolz, oder weil sie nichts anderes mehr können. In den Schatten der Kriege, in den Ruinen der Städte und auf den Schlachtfeldern des Südblocks sind sie das Rückgrat der modernen Konflikte.  \r

  Ein Söldner kann ein ehrenvoller Veteran sein, ein brutaler Straßenkämpfer oder ein kühler Leibwächter. Doch alle teilen dieselbe Wahrheit:  \r

  **Wer bezahlt, bestimmt, wer überlebt.**\r
  ...
  Söldner sind **Frontkämpfer und Überlebenskünstler**, die ihre Stärke, Erfahrung und Disziplin zu Waffen gemacht haben.  \r

  In einer Welt, in der Loyalität käuflich und Moral verhandelbar ist, sind sie Profis im Töten, Beschützen und Überleben.  \r

  Ob in den Kriegen des Nordimperiums, als private Sicherheitskräfte in elfischen Konzernen oder als Gesetzlose im Südblock – sie gehören zu den wenigen, die wissen, was Blut wirklich wert ist.\r
  ...
  Der Söldner ist der physische Mittelpunkt einer Gruppe – robust, gefährlich, direkt.  \r

  Er kann Tanks, Nahkämpfer oder Fernkämpfer sein, je nach Spezialisierung.  \r

  Seine Stärken sind Vielseitigkeit im Kampf, Zähigkeit und die Fähigkeit, in jeder Umgebung zu überleben.\r
  ...
  **Stärke** (für Nahkampf) oder **Geschicklichkeit** (für Fernkampf).  \r

  Sekundär wichtig: **Konstitution** (Überleben) oder **Weisheit** (Taktik).\r
  ...
  | **Rettungswürfe** | Zähigkeit (Experte), Reflex (Geübt), Willen (Geübt) |\r

  | **Fertigkeiten** | Wahrnehmung (Geübt) |\r

  | **Fertigkeiten pro Stufe** | 3 + INT-Modifikator |\r

  | **Klassenmerkmal** | Söldnerisches Training, Kampfstil |\r
  ...
  ### **Söldnerisches Training**\r

  Du bist ausgebildet, dich in jeder Lage zu behaupten.  \r
  ...
  **Effekt:** Du erhältst Fertigkeitstraining in **Kriegskunst** und **Überleben**. Wenn du bereits in einem dieser Bereiche trainiert bist, wähle stattdessen eine andere Fertigkeit.  \r
  ...
  Wähle deinen bevorzugten Kampfansatz.  \r

  Jeder Stil gewährt eine einzigartige Fähigkeit und bestimmt deine Entwicklung.\r

  \r

  #### **Frontkämpfer**\r

  Du stürzt dich in den Nahkampf und hältst die Linie.  \r

  - Erhalte den Feat *Power Attack*.  \r

  - Wenn du eine Rüstung trägst, erhältst du +1 AC gegen Nahkampfangriffe.\r

  \r

  #### **Scharfschütze**\r

  Du kämpfst aus der Distanz mit Präzision.  \r

  - Erhalte den Feat *Point-Blank Shot*.  \r

  - Wenn du auf eine stationäre Position zielst (keine Bewegung in dieser Runde), erhältst du +1 auf Angriffswürfe mit Fernkampfwaffen.\r

  \r

  #### **Wächter**\r

  Du bist Verteidiger und Schildträger.  \r
  ...
  ### **Erfahrener Kämpfer (3. Stufe)**\r

  Du hast gelernt, aus jedem Schlag zu lernen.  \r
  ...
  ### **Unnachgiebig (7. Stufe)**\r

  Deine Willenskraft ist so stark wie dein Körper.  \r

  Einmal pro Tag kannst du einen misslungenen Zähigkeits- oder Willenswurf wiederholen. Du musst das zweite Ergebnis verwenden.\r
  ...
  ### **Kriegsinstinkt (11. Stufe)**\r

  Deine Wahrnehmung von Gefahr ist fast übernatürlich.  \r
  ...
  ### **Veteran des Goldes (15. Stufe)**\r

  Du bist ein Relikt in einer Welt, die vergessen hat, was Krieg bedeutet.  \r

  Wenn du auf 0 Trefferpunkte fällst, bleibst du stattdessen bei 1 Trefferpunkt (einmal pro Tag).  \r

  Zusätzlich kannst du einmal täglich eine misslungene Einschüchterungsprobe automatisch als Erfolg werten.\r
  ...
  ### **Legende des Krieges (20. Stufe)**\r

  Dein Name ist Legende unter Soldaten und Söldnern.  \r
  ...
  | **1** | Zielsicherer Schlag | Wenn du dich in derselben Runde nicht bewegst, +2 auf den nächsten Angriff. |\r

  | **2** | Eisenkörper | +2 auf Rettungswürfe gegen Gifte, Krankheiten und Erschöpfung. |\r

  | **4** | Drohende Präsenz | Wenn du einen Gegner triffst, erhält dieser –1 auf Angriffswürfe für 1 Runde. |\r

  | **6** | Veteraneninstinkt | Du erkennst feindliche Taktiken. +1 auf Wahrnehmung und Initiative. |\r

  | **8** | Disziplinierter Kämpfer | Einmal pro Runde kannst du den Schaden um 2 reduzieren, wenn du Rüstung trägst. |\r

  | **10** | Klingenreflexe | Wenn du im Nahkampf angegriffen wirst, kannst du sofort 1 Schritt zurückweichen. |\r

  | **12** | Kalter Profi | Du kannst bei einem Angriffswurf 1W20 erneut würfeln, wenn du einen kritischen Fehlschlag erzielst (1/Tag). |\r

  | **14** | Unerbittlicher Sturm | Wenn du einen Gegner zu Boden bringst, erhältst du eine Bonusaktion (Schritt, Angriff oder Einschüchtern). |\r

  | **16** | Bluthand | Du heilst 1W8 TP, wenn du einen Gegner mit einem kritischen Treffer besiegst. |\r

  | **18** | Kugelfest | Resistenz 3 gegen Schusswaffenschaden. |\r

  | **20** | Kriegsveteran | Du ignorierst Mali durch Verwundung oder Erschöpfung für 1 Minute. |\r
  ...
  Ein Veteran der großen Kriege. Du bist auf Disziplin und Formation trainiert.  \r

  Erhalte zusätzliche +1 AC, wenn du dich neben einem Verbündeten befindest.\r

  \r

  ### **Leibwächter**\r

  Du bist Spezialist im Schutz anderer.  \r

  Wenn du die Aktion *Verteidigen* auf einen Verbündeten anwendest, erhält dieser zusätzlich Resistenz 2 gegen physischen Schaden.\r

  \r

  ### **Söldnerhauptmann**\r

  Du führst andere im Kampf.  \r
  ...
  Söldner sind die Realität der 1990er-Kriegswelt: ausgebrannt, bezahlt und gefährlich.  \r

  Sie sind keine Helden – aber sie sind die, die überleben.  \r

  Im Spiel verkörpern sie Härte, Pragmatismus und Professionalität – die Kälte jener, die den Preis des Blutes kennen."
schemaVersion: 1
source: legacy.world-rules
status: legacy
summary: Söldner sind Männer und Frauen, die gelernt haben, mit Waffen zu leben – und mit ihren Konsequenzen.
...
| **Klassenmerkmal** | Söldnerisches Training, Kampfstil |
