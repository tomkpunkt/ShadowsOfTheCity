...
rulesText: "# **Benommenheit**\r
  ...
  **Quelle:** Welt-Regelwerk (Zeitalter des Goldes)\r
  ...
  | Occult | Cantrip | 2 Aktionen | 60 Fuß | 1 Kreatur | 1 Runde |\r
  ...
  Du greifst in den Geist deines Ziels ein und verursachst Verwirrung.\r

  \r

  **Zauberwurf:** Willenswurf gegen deinen Zauber-SG\r

  **Effekt:** Das Ziel wird verwirrt und kann nur eine Aktion pro Runde ausführen.\r
  ...
  **Widerstand:** Das Ziel kann einen Willenswurf gegen deinen Zauber-SG machen, um dem Effekt zu widerstehen.\r
  ...
  - **Rang 1:** Dauer 2 Runden, das Ziel kann keine Aktionen ausführen\r

  - **Rang 2:** Dauer 3 Runden, das Ziel kann keine Aktionen ausführen\r

  - **Rang 3:** Dauer 4 Runden, das Ziel kann keine Aktionen ausführen\r
  ...
  - **Geflecht-Empfindlichkeit:** Kreaturen mit starkem magischen Geflecht (Elfen, einige Menschen) sind schwerer zu verwirren und erhalten +2 auf ihren Willenswurf.\r

  - **Technologische Abwehr:** Moderne Gehirn-Computer-Schnittstellen können die Verwirrung stören oder umleiten.\r
  ...
  > „Ein kleiner Stoß in den Geist – manchmal genügt das, um einen Gegner aus dem Gleichgewicht zu bringen.\"\r
