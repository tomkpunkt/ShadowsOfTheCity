...
rulesText: "# **Nachricht**\r
  ...
  **Quelle:** Welt-Regelwerk (Zeitalter des Goldes)\r
  ...
  | Arcane, Occult | Cantrip | 2 Aktionen | 120 Fuß | 1 Kreatur | Sofort |\r
  ...
  Du sendest eine kurze Nachricht direkt in den Geist einer Kreatur.\r

  \r

  **Effekt:** Du kannst eine Nachricht von bis zu 25 Wörtern an das Ziel senden. Das Ziel kann eine Antwort von bis zu 25 Wörtern zurücksenden.\r

  **Zusätzlich:** Die Nachricht ist völlig privat und kann von anderen nicht abgefangen werden.\r
  ...
  - **Rang 1:** Reichweite 240 Fuß, Nachricht kann bis zu 50 Wörter enthalten\r

  - **Rang 2:** Reichweite 480 Fuß, Nachricht kann bis zu 100 Wörter enthalten\r

  - **Rang 3:** Reichweite 960 Fuß, Nachricht kann bis zu 200 Wörter enthalten\r
  ...
  - **Geflecht-Verstärkung:** In Gebieten mit starkem magischen Geflecht kann die Nachricht über größere Entfernungen gesendet werden.\r

  - **Technologische Interferenz:** Moderne Überwachungssysteme können die Nachricht möglicherweise stören oder abfangen.\r
  ...
  > „Die Gedanken sind frei – und manchmal können sie die gefährlichsten Nachrichten übertragen.\"\r
