...
examples: []
id: feat.ancestry.zwerg.stahlkorper
legacy:
  notes: []
  paths:
...
prerequisites:
  - ancestry:
      id: ancestry.zwerg
references: []
rulesText: Deine Haut ist hart wie Metall. Du erhältst Resistenz 3 gegen physische Schäden (außer Energie). Wenn du Rüstung trägst, erhöht sich deine Schadensresistenz um +1.
schemaVersion: 1
source: legacy.world-rules
status: legacy
summary: Deine Haut ist hart wie Metall.
traits:
  - trait.ancestry
type: feat
---
