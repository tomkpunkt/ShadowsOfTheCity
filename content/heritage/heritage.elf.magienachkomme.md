...
examples: []
id: heritage.elf.magienachkomme
legacy:
  notes: []
  paths:
...
prerequisites:
  - ancestry:
      id: ancestry.elf
references: []
rulesText: Dein Blut trägt alte Macht. Du erhältst einen arkane Cantrip deiner Wahl. Der Attributsmodifikator für diesen Zauber ist Intelligenz.
schemaVersion: 1
source: legacy.world-rules
status: legacy
summary: Dein Blut trägt alte Macht.
traits:
  - trait.ancestry
type: heritage
---
