...
examples: []
id: class-feature.wachter.standhaftigkeit
legacy:
  notes: []
  paths:
...
prerequisites: []
references: []
rulesText: "Du bist selbst unter Schmerz und Blutverlust unbeirrbar.  \r
...
status: legacy
summary: Du bist selbst unter Schmerz und Blutverlust unbeirrbar.
traits:
  - trait.legacy
type: class-feature
---
