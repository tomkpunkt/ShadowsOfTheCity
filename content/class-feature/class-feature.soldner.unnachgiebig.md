...
examples: []
id: class-feature.soldner.unnachgiebig
legacy:
  notes: []
  paths:
...
prerequisites: []
references: []
rulesText: "Deine Willenskraft ist so stark wie dein Körper.  \r
...
status: legacy
summary: Deine Willenskraft ist so stark wie dein Körper.
traits:
  - trait.legacy
type: class-feature
---
